...
if (size>1) 
    ...
    M1 = funky(A11+A22, B11+B22, size/2);
    M2 = funky(A21+A22, B11, size/2);
    M3 = funky(A11, B12-B22, size/2);
    M4 = funky(A22, B21-B11, size/2);
    M5 = funky(A11+A12, B22, size/2);
    M6 = funky(A21-A11, B11+B12, size/2);
    M7 = funky(A12-A22, B21+B22, size/2);
